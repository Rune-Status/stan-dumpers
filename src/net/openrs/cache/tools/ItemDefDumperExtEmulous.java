...
public class ItemDefDumperExtEmulous {
	...
	public static final String EXPORT = "C:/Users/Stan/Desktop/RS/osrscache/type/ItemDefinitionsTom.json";
...
//				        					System.out.println("----");
				        		...
				        		if(infoBox.text().contains("High Alch") && !text.contains("Unknown") && !text.contains("?") && !text.contains("Depends")) {
				        		...
				        		} else if(infoBox.text().contains("Low Alch") && !text.contains("Unknown") && !text.contains("?") && !text.contains("Depends")) {
				        			String splitText = text.split("coins")[0].split("coin")[0].split("\\(")[0].replaceAll("Clean:", "").replaceAll("coins", "").replaceAll("coin", "").trim().replace(",", "").replaceAll("\u00A0", "");
				        			if (!splitText.isEmpty()) {
