...
public class PossibleAnimDumper {
	...
	public static final String EXPORT = "C:/Users/Stan/Desktop/RS/osrscache/type/PossibleanimsNoHumanoid.json";
	
	public static final String LISTFILE = "C:/Users/Stan/Desktop/RS/osrscache/type/sequences.txt";
	public static final String NPCFILE = "C:/Users/Stan/Desktop/RS/osrscache/type/npcs.txt";

	private static final boolean HUMANOID = false;
	...
	public static void main(String[] args) throws Exception {
		...
		while (npcIterator.hasNext()) {
			...
			if (!HUMANOID && walkAnims.contains(819)) {
		    	json.name("type");
		    	json.value("HUMANOID");
			} else {
