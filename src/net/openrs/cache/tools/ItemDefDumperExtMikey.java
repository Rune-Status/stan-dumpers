...
public class ItemDefDumperExtMikey {
	...
	public static final String EXPORT = "C:/Users/Stan/Desktop/RS/osrscache/type/ItemDefinitionsMikey.json";
						...
						for (org.jsoup.nodes.Element infoBox : list) {
							...
							if (examineNext) {
									...
									if (slotElement.last() != null) {
										...
										case "Body":
											...
											if (item.name.toLowerCase().contains("body")
													...
													|| item.name.toLowerCase().contains("garb")) {
												item.body = true;
											}
											break;
										case "Shield":
								...
								if (infoBox.text().contains("High Alch") && !text.contains("Unknown")
										&& !text.contains("?")) {
									String splitText = text.split("coins")[0].split("coin")[0].split("\\(")[0]
											.replaceAll("Clean:", "").replaceAll("coins", "").replaceAll("coin", "")
